...
object GameNotInSeason : Failure("No game with that id is registered in this season")
object InvalidLoginCredentials : Failure("Invalid login credentials")
object JwtSerializationException : Failure("Failed to process jwt")